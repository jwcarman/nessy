...
/**
 * Anthropic's registration as a Boot citizen: what {@code ANTHROPIC_API_KEY} in the environment —
 * read here as the property Boot's relaxed binding turns it into — contributes, and what it does
 * not.
 */
@DisplayName("Anthropic's auto-configuration")
