 ...
 * puts on the wire, and an {@code execute} nothing calls.
 *
 * <p>Replaces the old {@code ToolSpec}, which was exactly this triple as a record. Request assembly
 * now reads those three off {@link Tool} itself, so a test that wants to assert on what was
 * declared needs a whole tool rather than a description of one.
 */
