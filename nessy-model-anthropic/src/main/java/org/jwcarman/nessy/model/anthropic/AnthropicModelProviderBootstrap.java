 ...
 * application would write, not {@link AnthropicModelProvider#fromEnv()}, so the key discovery saw
 * is the key that gets built and no other SDK-level variable is read underneath it.
 */
