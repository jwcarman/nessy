...
`docs/superpowers/specs/2026-08-20-durable-computation.md`, and the vocabulary
amendment `docs/superpowers/specs/2026-08-20-action-and-tool-vocabulary.md`
(which amends `2026-08-16-authorization-design.md`) are the design of record. Its decisions (zones, naming conventions, the grant
