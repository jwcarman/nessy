...
`docs/superpowers/specs/2026-08-18-agent-as-scope-design.md` and its companion
`docs/superpowers/specs/2026-08-20-durable-computation.md` are the design of
record. Its decisions (zones, naming conventions, the grant
