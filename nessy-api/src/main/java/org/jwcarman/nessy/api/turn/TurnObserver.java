 ...
 * homework. Bound per entry: the observer handed to {@code observe} or {@code drive} sees the
 * segment that call starts, and nothing after a park. The consumer may not exist at all — an
 * unattended agent runs every turn against {@link #noop()} and loses nothing.
 *
