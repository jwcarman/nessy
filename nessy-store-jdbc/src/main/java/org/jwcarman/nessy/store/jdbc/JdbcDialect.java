...
/**
 * The five databases {@code nessy-store-jdbc} speaks, and the resolver that picks one from a live
  ...
  private static IllegalStateException unrecognized(String product) {
    return new IllegalStateException(
        "unrecognized JDBC product \""
            + product
            + "\" — nessy-store-jdbc supports POSTGRES, MYSQL, MARIADB, SQLSERVER, and ORACLE;"
