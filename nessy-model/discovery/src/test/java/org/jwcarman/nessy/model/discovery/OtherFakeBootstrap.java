...
/** A second bootstrap type, so a duplicate-name message can be seen to name BOTH classes. */
final class OtherFakeBootstrap implements ModelProviderBootstrap {

  private final FakeBootstrap delegate;

  OtherFakeBootstrap(String name, String environmentVariable, String defaultModelId) {
    this.delegate = new FakeBootstrap(name, environmentVariable, defaultModelId);
  }
