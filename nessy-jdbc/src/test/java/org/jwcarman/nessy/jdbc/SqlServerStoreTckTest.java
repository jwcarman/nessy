...
/**
 * The full TCK, all seven contracts, run against a real SQL Server — plus the dialect-resolution
 * pin (design §6). One container for the whole class (nested contracts share it, each truncating
 * its own table between tests) rather than six, the same efficiency trade the vendor matrix needs
