...
class InMemoryNotebookTest {
  ...
  class Saving {
    ...
    void saving_twice_under_the_same_name_replaces_the_entry() {
      SubjectId subject = new SubjectId("subject-1");
      notebook.save(subject, new Notebook.Entry("user-taste", "Prefers terse answers", "v1"));

      notebook.save(subject, new Notebook.Entry("user-taste", "Prefers metric units", "v2"));
  ...
  class Headings {
    ...
    void headings_come_back_alphabetical_by_name_regardless_of_save_order() {
      SubjectId subject = new SubjectId("subject-1");
      notebook.save(subject, new Notebook.Entry("zebra-facts", "Hook z", "Body z"));
      notebook.save(subject, new Notebook.Entry("apple-facts", "Hook a", "Body a"));
      notebook.save(subject, new Notebook.Entry("mango-facts", "Hook m", "Body m"));

      assertThat(notebook.headings(subject))
          .containsExactly(
              new Notebook.Heading("apple-facts", "Hook a"),
              new Notebook.Heading("mango-facts", "Hook m"),
              new Notebook.Heading("zebra-facts", "Hook z"));
    }
    ...
    void headings_carry_no_bodies() {
      ...
      assertThat(headings)
          .containsExactly(new Notebook.Heading("user-taste", "Prefers terse answers"));
    }
  }
  ...
  class Subject_isolation {
    ...
    void two_subjects_never_see_each_others_notes() {
      ...
      notebook.save(first, new Notebook.Entry("user-taste", "Prefers terse answers", "Full body"));
