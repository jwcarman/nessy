...
public final class Calls {
  ...
  public static Optional<ToolCallRecord> byTool(AgentState state, String tool) {
  ...
  public static Optional<ToolCallRecord> byTool(Phase.WorkingTools working, String tool) {
    return working.calls().stream().filter(call -> tool.equals(call.tool())).findFirst();
  }

  /** A call still waiting on a human. */
  public static Optional<String> pending(AgentState state, String tool) {
