...
public final class SendEmailTool implements Tool<SendEmailTool.Input> {
  ...
  public ObjectNode inputSchema() {
    ...
    properties.putObject("to").put("type", "string").put("description", "Recipient address");
    properties.putObject("subject").put("type", "string").put("description", "Subject line");
    properties.putObject("body").put("type", "string").put("description", "Message body");
