 ...
 * thinking, redacted thinking, tool use, tool results — is invisible here, on purpose: this is the
 * chat log, not the trace. A message with no {@code TextBlock}s (a pure tool-results message, an
 * empty turn) contributes nothing rather than an empty {@link Line}.
 */
public final class TranscriptView {

  private TranscriptView() {}

  /** One line of the chat log: who said it, and what they said. */
