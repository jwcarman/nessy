...
class ToolWorkerTest {
  ...
  void a_remember_that_throws_never_settles_the_call() {
    ...
    Substrate substrate = new BatchThrows(new InMemorySubstrate(Clock.systemUTC()));
  ...
  /**
   * A {@link Substrate} whose {@code batch} always fails -- exactly what {@code remember} calls.
   */
  private record BatchThrows(Substrate delegate) implements Substrate {
