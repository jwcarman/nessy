 ...
 *
 * <pre>
 *   ./mvnw -pl nessy-examples/watchman test -Dnessy.excludedGroups= -Dtest=LmStudioRoundDemo
 * </pre>
 *
 * <p>Needs LM Studio serving {@code qwen/qwen3.6-35b-a3b} and the {@code watchman} schema. Asserts
 * loosely on purpose: a real model decides for itself which tools to call, and what it actually
 * does is the observation this demo exists to produce.
 */
@Tag("live")
@Tag("container")
