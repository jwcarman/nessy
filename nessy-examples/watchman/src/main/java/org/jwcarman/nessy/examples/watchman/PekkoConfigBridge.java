 ...
 * serializers, persistence plugin ids, coordinated shutdown — live in {@code watchman.conf}, where
 * HOCON's substitutions and includes work properly. Operational settings that an operator DOES
 * touch — the database, the cron, timeouts — live in {@code application.yml} where every other
