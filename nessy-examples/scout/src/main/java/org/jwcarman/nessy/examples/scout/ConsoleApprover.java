 ...
 *
 * <p>Reproduced, verbatim, from {@code chat-cli}'s {@code ConsoleApprover} ({@code
 * nessy-examples/chat-cli/src/main/java/org/jwcarman/nessy/examples/ConsoleApprover.java}): that
 * class is package-private, and examples don't depend on each other, so scout carries its own copy
 * in its own package rather than reaching across module boundaries for one small class.
 */
